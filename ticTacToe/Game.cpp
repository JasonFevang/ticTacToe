...
marker Game::winner() {
	...
	if (board->getSpace(0) == board->getSpace(1) && board->getSpace(0) == board->getSpace(2))
		return board->getSpace(0);
	//check middle horizontal
	if (board->getSpace(3) == board->getSpace(4) && board->getSpace(3) == board->getSpace(5))
		return board->getSpace(3);
	//check bottom horizontal
	if (board->getSpace(6) == board->getSpace(7) && board->getSpace(6) == board->getSpace(8))
		return board->getSpace(6);
	///vertical///
	//check left vertical
	if (board->getSpace(0) == board->getSpace(3) && board->getSpace(0) == board->getSpace(6))
		return board->getSpace(0);
	//check middle vertical
	if (board->getSpace(1) == board->getSpace(4) && board->getSpace(1) == board->getSpace(7))
